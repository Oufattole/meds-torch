...
def test_clmbr(tmp_path):
    ...
    def nest(df: pl.DataFrame) -> pl.DataFrame:
        ...
        This function reconstructs the nested structure by grouping by patient ids and
        subnesting by event times
    ...
    # example_batch = processor.collate(
    #     [processor.convert_patient(train_dataset["train"][0], tensor_type="pt")]
    # )
    ...
    model.save_pretrained(os.path.join(tmp_path, "clmbr_model"))
