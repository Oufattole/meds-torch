...
conda activate meds-torch-debug
...
export PIPELINE_CONFIG_FP=$(pwd)/tests/helpers/configs/ecg_triplet_config.yaml
export MODEL_DIR=$(pwd)/tests/test_data/ecg_triplet_tensors
MEDS_transform-runner "pipeline_config_fp=$PIPELINE_CONFIG_FP"
