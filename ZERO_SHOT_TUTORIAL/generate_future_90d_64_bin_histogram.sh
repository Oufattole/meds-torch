...
PRETRAIN_OUTPUT_DIR="${ROOT_DIR}/results/zero_shot/histogram_eic_63_token_bin_size"
...
# TIME_OUTPUT_DIR="/storage/shared/mimic-iv/meds_v0.3.2/results/zero_shot/inference/eic/time/icu_discharge/90d/2025-01-03_03-20-21_597300/"
# paths.time_output_dir=${TIME_OUTPUT_DIR}
...
for TASK_NAME in "${TASKS[@]}"; do
    ...
    meds-torch-generate --multirun hydra/launcher=joblib model=histogram_forecasting experiment=64_bin_histogram_eic_inference_mtr \
        ...
        data.dataloader.batch_size=512 trainer.devices=[0,1] data.predict_dataset=test \
