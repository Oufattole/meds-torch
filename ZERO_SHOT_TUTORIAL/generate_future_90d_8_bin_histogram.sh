...
PRETRAIN_OUTPUT_DIR="${ROOT_DIR}/results/zero_shot/histogram_eic_debug"
...
for TASK_NAME in "${TASKS[@]}"; do
    ...
    meds-torch-generate --multirun hydra/launcher=joblib model=histogram_forecasting experiment=8_bin_histogram_eic_inference_mtr \
